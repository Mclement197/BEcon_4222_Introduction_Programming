...
![](../../assets/img/ex_01/open_vscode.gif){width="700px"}
:::
...
![](../../assets/img/ex_01/open_terminal_vscode.gif){width="600px"}
:::
...
**Note**: PowerShell is only needed to install `uv` (recommended method). For the rest of the course, we'll use Command Prompt in exercises to keep everyone on the same page. Feel free to use PowerShell if you prefer, but examples will use Command Prompt.
...
![](../../assets/img/ex_01/init_uv.gif){width="800px"}
![](../../assets/img/ex_01/add_uv.gif){width="800px"}
:::
...
![](../../assets/img/ex_01/runpython_uv.gif){width="800px"}
:::
...
*Note*: it could be that VSCode does not detect your interpreter right away. In this case, first try to refresh VSCode using CTRL/CMD + SHIFT + P and then "Developer: Reload Window".

Otherwise, select "Enter interpreter path" and navigate to the `.venv` folder in your project, then select the Python executable:
...
##### Windows
![](../../assets/img/ex_01/select_python_interpreter.png){width="640px"}

##### Mac
![](../../assets/img/ex_01/select_python_interpreter_macos.png)
...
##### Windows
![](../../assets/img/ex_01/select_python_interpreter_bottomright.png){width="640px"}

##### Mac
![](../../assets/img/ex_01/select_python_interpreter_bottomright_macos.png)
...
![](../../assets/img/ex_01/terminal_meme.jpg){width="440px"}
