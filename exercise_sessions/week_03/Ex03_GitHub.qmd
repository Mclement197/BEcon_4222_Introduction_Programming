...
Use Git Graph <!-- @Aurelien: how/where? in VSC or the bash? -->  to visualize the history of commits. You should see the different branches from our contributors.
...
3. Check the initial state of the repo using `git status`. You should see a text file `trivia.txt` and a README file when printing the folder's contents vis `ls`.
