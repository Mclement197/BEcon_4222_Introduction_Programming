...
- Visibility as a programmer (your portfolio - GitHub fulfills some signaling function and works as a social network for programmers)
:::
:::
...
![](../../assets/img/lecture_03_github/pushpull_meme.png){height="370px"}
...
... set it up once, can be nerve-wracking, done forever, takes about 10 minutes ...
...
You have two options to create a local repository and link it to GitHub:

1. Create a local repository first, then link it to GitHub
2. Clone the repository from GitHub locally




## Option 1: Create a local repository first
...
## Option 2: Clone the repository from GitHub locally
...
:::: {.columns}
::: {.column width="50%"}
![](../../assets/img/lecture_03_github/meme_pr_1.png){width=100% style="margin-bottom: 8px;"}

![](../../assets/img/lecture_03_github/meme_pr_2.png){width=100%}
:::
::: {.column width="50%"}
![](../../assets/img/lecture_03_github/meme_pr_3.png){width=100% style="margin-bottom: 8px;"}

![](../../assets/img/lecture_03_github/meme_pr_4.png){width=100%}
:::
::::
...
There are many more features of Git and GitHub that we won't cover in this course, but you can explore them on your own if you're interested.
